# .NET MAUI Backdrop Page Getting Started

This repository contains sample to get started with the [Syncfusion .NET MAUI BackdropPage](https://help.syncfusion.com/maui/backdrop/getting-started) control. The .NET MAUI Backdrop page comprises two surfaces: a back layer and a front layer. The back layer holds actionable content (like navigation or filtration), which is relevant to the front layer.
